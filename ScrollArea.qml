    ...
    Flickable {
        ...
        flickableDirection: {
            if (_verticalBar.visible) {
                return _horizontalBar.visible ? Flickable.AutoFlickDirection : Flickable.VerticalFlick
            }
            else {
                return _horizontalBar.visible ? Flickable.HorizontalFlick : Flickable.AutoFlickDirection
            }
        }
